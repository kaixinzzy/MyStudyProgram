package cn.com.zzy.LruCache.utils;
...
//        List<DouyuArticle> items = XmlParser.parse(is);
//        for (DouyuArticle item : items) {
...
//        List<DouyuArticle> items = JsonParser.parse(jsonString);
//        StringBuilder sb = new StringBuilder();
//        for (DouyuArticle item : items) {
//            sb.append(item.toString()).append("\n");
//        }
