...
/**
 * Created by BCLZzy on 2017/11/7.
 */
...
public class MyBaseGlideUrlLoader extends BaseGlideUrlLoader<String> {
    ...
    public MyBaseGlideUrlLoader(ModelLoader<GlideUrl, InputStream> concreteLoader, ModelCache<String, GlideUrl> modelCache) {
    ...
    public static class Factory implements ModelLoaderFactory<String,InputStream> {
        ...
        public ModelLoader<String, InputStream> build(MultiModelLoaderFactory multiFactory) {
            return new MyBaseGlideUrlLoader(multiFactory.build(GlideUrl.class,InputStream.class),urlCache);
        }
